...
Check out the [example configuration](https://github.com/DreamMaoMao/mango-config) by the creator of MangoWC, including complete setups for MangoWC, Waybar, Rofi, and more.
